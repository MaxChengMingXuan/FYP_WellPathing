<?php
	...
	$sqlloadresult = "SELECT * FROM tbl_results t1 INNER JOIN tbl_users t2 ON t2.user_id = t1.user_id WHERE t2.user_role = '$userrole'";
    ...
    sendJsonResponse($response);
		...
		$response = array('status' => 'failedsql', 'data' => null);
    sendJsonResponse($response);
	}
